                            ...
                            <div class="row">
                                ...
                                ?>
                                    ...
                                    <input type="hidden" value="<?php echo $student_id; ?>" name="txthfsid" />
                                        ...
                                        <select class="form-control custom-select" name="institute_id" >
                                        ...
                                        <?php 
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_name" type="text" class="form-control" id="validationCustom02" value="<?php echo $student_name; ?>" >
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_contact" type="number_format" class="form-control" id="validationCustom02" value="<?php echo $student_contact; ?>" >
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="student_uname" type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="<?php echo $student_uname; ?>" >
                                        ...
                                        <div class="col-md-6 mb-10">
                                            ...
                                            <input name="student_profile_picture" type="file" class="custom-file-input" id="validatedCustomFile" value="<?php echo $student_profile_picture; ?>" >
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input name="student_department" type="text" class="form-control" id="validationCustom04" value="<?php echo $student_department; ?>" >
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 mb-10">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_approved_datetime" type="date" class="form-control" id="approved_date" value="<?php echo $student_approved_datetime; ?>" >
                                                <div class="invalid-feedback">
                                                    Please provide a valid Date.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row"> 
                                            ...
                                            <input name="student_isactive" type="radio" class="custom-control-input" id="customControlValidation2" value="yes" <?php if($student_isactive=="yes") { ?> checked="checked" <?php } ?> required>
                                            <label class="custom-control-label" for="customControlValidation2">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input name="student_isactive" type="radio" class="custom-control-input" id="customControlValidation3" value="no" <?php if($student_isactive=="no") { ?> checked="checked" <?php } ?> required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div>
                                                <div class="custom-control custom-radio mb-10">
                                            <input name="student_isapproved" type="radio" class="custom-control-input" id="customControlValidation4" value="no" <?php if($student_isapproved=="no") { ?> checked="checked" <?php } ?>  required>
                                            <label class="custom-control-label" for="customControlValidation4">Pending</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input name="student_isapproved" type="radio" class="custom-control-input" id="customControlValidation5" value="yes" <?php if($student_isapproved=="yes") { ?> checked="checked" <?php } ?>  required>
                                        ...
                                        <textarea name="student_address" class="form-control mt-15" ><?php echo $student_address; ?></textarea>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_landmark" type="text" class="form-control" id="validationCustom02" placeholder="Landmark" value="<?php echo $student_landmark; ?>" >
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <input name="student_pincode" type="number_format" class="form-control" id="validationCustom02" placeholder="Pin Code" value="<?php echo $student_pincode; ?>" >
