        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage State</h4>
                </div>
                <!-- /Title -->
            <?php
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_state where state_id='".$_REQUEST['hfdelstate']."'");
                if($res)
                {
                     echo "<script>window.location='view_location_state.php';</script>";
                } else {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_state.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from tbl_state ORDER BY state_id DESC");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <a  href="update_state.php?edit=<?php echo $row["state_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                            data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a href="" data-id="<?php echo $row["state_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelstate" name="hfdelstate" />
                                                </div>
