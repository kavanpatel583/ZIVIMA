                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    if(isset($_REQUEST["btnsave"]))
                                    {
                                         ...
                                         student_department,student_dob,student_qualification,student_isapproved,
                                         student_added_datetime,student_approved_datetime,student_address,student_landmark,student_pincode,institute_id,district_id) 
                                         ...
                                         '".$_REQUEST["student_qualification"]."','".$_REQUEST["student_isapproved"]."',now(),
                                         '".$_REQUEST["student_approved_datetime"]."','".$_REQUEST["student_address"]."','".$_REQUEST["student_landmark"]."','".$_REQUEST["student_pincode"]."',
                                    ...
                                    <form class="needs-validation" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_name" type="text" class="form-control"
                                                    id="validationCustom02" placeholder="Name" value="" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_contact" type="number_format" class="form-control"
                                                    id="validationCustom02" placeholder="Contact" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="student_uname" type="text" class="form-control"
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="student_email" type="email" class="form-control"
                                                        id="exampleInputEmail_1" placeholder="Enter email">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom03">Profile Photo</label>
                                                <div class="custom-file">
                                                    <input name="student_profile_picture" type="file"
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input name="student_department" type="text" class="form-control"
                                                    id="validationCustom04" placeholder="Department" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input name="student_dob" class="form-control" type="date"
                                                    name="birthday" value="10/24/1984" />
                                                <div class="invalid-feedback">
                                                    Please provide a valid Department.
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input name="student_qualification" type="text" class="form-control"
                                                    id="validationCustom05" placeholder="Qualification" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_pwd" type="password" id="inputPassword5"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_approved_datetime" type="date" class="form-control"
                                                    id="approved_date" value="" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div>
                                                    <div class="custom-control custom-radio mb-10">
                                                        <input name="student_isapproved" type="radio" value="no"
                                                            class="custom-control-input" id="customControlValidation4"
                                                            required>
                                                        <label class="custom-control-label"
                                                            for="customControlValidation4">Pending</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input name="student_isapproved" type="radio" value="yes"
                                                            class="custom-control-input" id="customControlValidation5"
                                                            required>
                                                        <label class="custom-control-label"
                                                            for="customControlValidation5">Approved</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <textarea name="student_address" class="form-control mt-15" rows="3"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_landmark" type="text" class="form-control"
                                                    id="validationCustom02" placeholder="Landmark" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_pincode" type="number_format" class="form-control"
                                                    id="validationCustom02" placeholder="Pin Code" value="" required>
