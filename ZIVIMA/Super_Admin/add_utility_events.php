        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add Events</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_event(event_title,event_description,event_datetime,event_venue,event_advantages,event_landmark,event_pincode,event_main_feature,state_admin_id) 
                                         values ('".$_REQUEST["event_title"]."','".$_REQUEST["event_description"]."','".$_REQUEST["event_datetime"]."','".$_REQUEST["event_venue"]."','".$_REQUEST["event_advantages"]."','".$_REQUEST["event_landmark"]."','".$_REQUEST["event_pincode"]."','".$_REQUEST["event_main_feature"]."','".$_REQUEST["state_admin_id"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                ...
                                ?>
                                    ...
                                    <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                              ...
                                              {
                                            ?>
                                                    <option value="<?php echo $row["state_admin_id"]; ?>">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="event_title" class="form-control" id="validationCustom01" placeholder="Title of Event" value="" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="event_description" class="form-control" id="validationCustom01" placeholder="Event Description" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="date" class="form-control" id="validationCustom03" name="event_datetime" required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" placeholder="Event Advantages" name="event_venue" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Date! 
                                                </div>
                                            </div>                                      
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="event_advantages" class="form-control" id="validationCustom01" placeholder="Event Advantages" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="event_landmark" class="form-control" id="validationCustom01" placeholder="Landmark of Event" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="event_pincode" class="form-control" id="validationCustom01" placeholder="Pin Code" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="event_main_feature" class="form-control" id="validationCustom01" placeholder="Main Feature of Event" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
