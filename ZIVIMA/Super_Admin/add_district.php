        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="AdminDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="view_location_district.php">Manage District</a></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add District</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    if(isset($_REQUEST["btnsave"]))
                                    {
                                         ...
                                         $res=mysqli_query($con,"insert into tbl_district (district_name,state_id) values ('".$_REQUEST["txtdname"]."','".$_REQUEST["state_id"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                         } else {
                                    ...
                                    <form class="needs-validation" method="post" novalidate>
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="txtdname" class="form-control" id="validationCustom01" placeholder="State Name" value="" required>
                                            ...
                                            <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom02">Select State</label>
                                                <select name="state_id" class="form-control custom-select" required>
