...
<head>
    ...
    <title>Admin - Update District</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Update District</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                        $res= mysqli_query($con,"select * from tbl_district where district_id='". $_REQUEST["edit"]."'");
                                 ...
                                 if(isset($_REQUEST['btnsave']))
                                 {
                                      ...
                                      $result= mysqli_query($con,"update tbl_district set district_name='".$_REQUEST["district_name"]."' where district_id='".$_REQUEST["txthfdid"]."'");
                                ...
                                ?>
                                    ...
                                    <input type="hidden" value="<?php echo $id; ?>" name="txthfdid" />
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">District Name</label>
                                                <input type="text" name="district_name" class="form-control" id="validationCustom01" 
                                                placeholder="State Name" value="<?php echo $name; ?>" required>
