                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    if(isset($_REQUEST["btnsave"]))
                                    {
                                         ...
                                         student_department,student_dob,student_qualification,student_isactive,student_isapproved,
                                         ...
                                         '".$_REQUEST["student_qualification"]."','".$_REQUEST["student_isactive"]."','".$_REQUEST["student_isapproved"]."',now(),
                                    ...
                                    <form class="needs-validation" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div>
                                                    <div class="custom-control custom-radio mb-10">
                                                        <input name="student_isactive" type="radio"
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div>
                                                    <div class="custom-control custom-radio mb-10">
                                                        <input name="student_isapproved" type="radio"
