...
<head>
    ...
    <title>Admin - Add State Admin</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="view_state_admin.php">Manage State Admin</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Add State Admin</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                    data-feather="external-link"></i></span></span>Add State Admin</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {   
                                        ...
                                        $sql=mysqli_query($con,"select * from tbl_state_admin_login where state_id='".$_REQUEST["state_id"]."'");
                                        if(mysqli_num_rows($sql)<=0)
                                        {
                                            $res=mysqli_query($con,"insert into tbl_state_admin_login (state_admin_name,state_admin_uname,state_admin_pwd,state_admin_contact,state_id) values ('".$_REQUEST["txtsaname"]."','".$_REQUEST["txtsauname"]."','".$_REQUEST["txtsapwd"]."','".$_REQUEST["txtsacontact"]."','".$_REQUEST["state_id"]."')");
                                            if($res)
                                            {
                                            echo "inserted ..";
                                            } else {
                                ...
                                ?>
                                    ...
                                    <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                               ...
                                               $res=mysqli_query($con,"select * from tbl_state where state_id not in (select state_id from tbl_state_admin_login)");
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="txtsaname" class="form-control"
                                                    id="validationCustom01" placeholder="Full Name" value="" required>
                                            </div>
                                        </div><!-- End Form-row -->
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="number" name="txtsacontact" class="form-control"
                                                    id="validationCustom01" placeholder="Contact Number" value="" required>
                                            </div>
                                        </div><!-- End Form-row -->

                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Uname</label>
                                                <input type="text" name="txtsauname" class="form-control"
                                                    id="validationCustom01" placeholder="User Name" value="" required>
                                            </div>
                                        </div><!-- End Form-row -->
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="password" name="txtsapwd" class="form-control"
                                                    id="validationCustom01" placeholder="e.g. Abcd@1234" required>
                                            </div>
                                        </div><!-- End Form-row -->
