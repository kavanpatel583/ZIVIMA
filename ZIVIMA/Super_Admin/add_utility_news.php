                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_news(news_title,news_title_description,news_description,state_admin_id) values ('".$_REQUEST["news_title"]."','".$_REQUEST["news_title_description"]."','".$_REQUEST["news_description"]."','".$_REQUEST["state_admin_id"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
