        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>List of Users</h4>
                </div>
                <!-- /Title -->
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 ">
                                            ...
                                            <tbody>
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select U.*,D.district_name from tbl_user U left join tbl_district as D on D.district_id=U.district_id");
                                               while($row=mysqli_fetch_array($res))
                                              {
                                            ?> 
                                                <tr>     
                                                    <td><?php echo $i; ?></td>
                                                    <td><img src="../uploads/users/<?php echo $row["user_profile_picture"]; ?>" style="height:80px; width:80px;" /></td>
