...
<head>
    ...
    <title>Admin - Utility News</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>List of all News</h4>
                </div>
                <!-- /Title -->
                                            ...
                                            ?> 
                                                <tr>     
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- <a  href="update_news.php?edit=<?php echo $row["news_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
