...
<head>
    ...
    <title>Admin - Add District Collector</title>
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_district_collector(state_admin_id,district_id,district_collector_name,district_collector_uname,district_collector_pwd,district_collector_contact) values ('".$_REQUEST["state_admin_id"]."','".$_REQUEST["district_id"]."','".$_REQUEST["district_collector_name"]."','".$_REQUEST["district_collector_uname"]."','".$_REQUEST["district_collector_pwd"]."','".$_REQUEST["district_collector_contact"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                         } else {
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-10">
                                                    ...
                                                    <input type="password" name="district_collector_pwd" class="form-control" id="validationCustom01" placeholder="Password" value="" required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
