...
<head>
    ...
    <title>Admin - Problem Category</title>
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["problem_category_isactive"]; ?></td>
                                                    <td>
                                                        ...
                                                        <a href="" data-id="<?php echo $row["problem_category_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> -->
                                                    </td> 
                                                    </td>
                                                </tr>
                                              <?php 
