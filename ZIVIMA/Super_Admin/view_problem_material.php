...
<head>
    ...
    <title>Admin - View Problem Material</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="">Problem Statements</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Problem Material</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="" data-id="<?php echo $row["problem_material_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> -->
                                                    </td>
                                                    </td>
                                                </tr>
                                              <?php 
