        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="">Locations</a></li>
                    <li class="breadcrumb-item"><a href="view_location_state.php">State</a></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Update State</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                        $res= mysqli_query($con,"select * from tbl_state where state_id='". $_REQUEST["edit"]."'");
                                 ...
                                 if(isset($_REQUEST['btnsave']))
                                 {
                                      ...
                                      $result= mysqli_query($con,"update tbl_state set state_name='".$_REQUEST["state_name"]."' where state_id='".$_REQUEST["txthfsid"]."'");
                                    ...
                                    <input type="hidden" value="<?php echo $id; ?>" name="txthfsid" />
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="state_name" class="form-control" id="validationCustom01" 
