...
<head>
    ...
    <title>Admin - Add Polling Question</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="view_polling_questions.php">Polling Questions</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Add Polling Question</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
