...
<head>
    ...
    <title>Admin - Manage District</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage District</h4>
                </div>
                <!-- /Title -->
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_district where district_id='".$_REQUEST['hfdeldistrict']."'");
                if($res)
                {
                     echo "<script>window.location='view_location_district.php';</script>";
                } else {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_district.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add District</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               ...
                                               $res=mysqli_query($con,"select D.*,S.state_name from tbl_district D LEFT JOIN tbl_state as S ON S.state_id=D.state_id ORDER BY D.district_name DESC");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <a  href="update_district.php?edit=<?php echo $row["district_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                            data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a href="" data-id="<?php echo $row["district_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdeldistrict" name="hfdeldistrict" />
                                                </div>
