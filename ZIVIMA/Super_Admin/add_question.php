                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_district_collector(state_admin_id,district_id,district_collector_name,district_collector_uname,district_collector_pwd,district_collector_contact,district_collector_isactive) values ('".$_REQUEST["state_admin_id"]."','".$_REQUEST["district_id"]."','".$_REQUEST["district_collector_name"]."','".$_REQUEST["district_collector_uname"]."','".$_REQUEST["district_collector_pwd"]."','".$_REQUEST["district_collector_contact"]."','".$_REQUEST["district_collector_isactive"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                         } else {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm">
                                                    ...
                                                    <div class="custom-control custom-radio mb-10">
                                                        ...
                                                        name="district_collector_isactive" value="1" checked="checked" required>
                                                    ...
                                                    <div class="custom-control custom-radio mb-10">
                                                        ...
                                                        name="district_collector_isactive" value="0" required>
