       ...
       <?php include 'Header.php'; ?>
        ...
        <div class="hk-pg-wrapper">
            ...
            <li class="breadcrumb-item"><a href="InstituteDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage Approved Questions</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
...
<div class="hk-pg-header">
    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Approved Questions</h4>
</div>
<!-- /Title -->
<?php
if (isset($_REQUEST['btndelete'])) {

    $res = mysqli_query($con, "delete from tbl_question where question_id='" . $_REQUEST['hfdelques'] . "'");
    if ($res) {
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display">
                                            ...
                                            <tbody>
                                             <?php 
                                            $i = 1;
                                            $res = mysqli_query($con, "select tbl_question.*,tbl_problem_statement.problem_st_title from tbl_question left join tbl_problem_statement on tbl_problem_statement.problem_st_id=tbl_question.problem_st_id
                                        ");
                                            while ($row = mysqli_fetch_array($res)) {
                                                ...
                                                <tr>     
                                                    ...
                                                    <td><a href="view_questions_more.php?edit=<?php echo $row["question_id"] ?>" 
                                                    class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                    </td>                                           
                                                </tr>
                                                <?php 
                                                $i++;
