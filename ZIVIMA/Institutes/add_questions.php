        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add Questions</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_question(question_title,problem_category_id,
                                         question_description,student_id,problem_st_id)values 
                                         ('".$_REQUEST["txtqtitle"]."','".$_REQUEST["problem_cat_id"]."',
                                         '".$_REQUEST["txtdesc"]."',
                                         '".$_REQUEST["studentid"]."','".$_REQUEST["problem_stmt_id"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                ...
                                ?>
                                    <form class="needs-validation" method="post" novalidate>
                                        ...
                                        <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="txtqtitle" class="form-control" id="validationCustom02" placeholder="Question title" value="" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <textarea class="form-control mt-15" rows="4" placeholder="Question Description" name="txtdesc"></textarea>
                                            </div>
                                        </div>

                                        <button class="btn btn-primary" type="submit" style="float: right" name="btnsave">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </section>
