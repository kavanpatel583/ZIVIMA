        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="view_questions.php">View Question</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Add reply</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add Reply   </h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into  tbl_question_reply (question_id,que_reply_text) values ('".$_REQUEST["txtqid"]."','".$_REQUEST["que_reply_text"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                         } else {
                                    ...
                                    <form class="needs-validation" method="post" novalidate>
                                        ...
                                        <div class="form-row">
                                            <!-- <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Problem Catagory</label>
                                                <select class="form-control custom-select" name="state_admin_id" required>
                                                    <option value="">Select Problem Catagory</option>
                                                    <?php 
                                        ...
                                        <div class="form-row">
                                            <input type="hidden" name="txtqid" value="<?php echo $_REQUEST["edit"]; ?>" />
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom02">Question Reply</label>
                                                <textarea name="que_reply_text" class="form-control mt-15" rows="3"
                                                    placeholder="Question Reply Description"></textarea>
                                            </div>
                                        </div>
                                        
                                        <div><br/>
                                        <button class="btn btn-primary" type="submit" name="btnsave">Send</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
