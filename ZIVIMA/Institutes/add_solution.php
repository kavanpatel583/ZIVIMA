                        ...
                        <section class="hk-sec-wrapper">
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_solution (solution_project_name,solution_description,
                                         problem_st_id)
                                         values ('".$_REQUEST["solution_project_name"]."','".$_REQUEST["solution_description"]."','".$_REQUEST["problem_st_id"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                ...
                                ?>
                                    <form class="needs-validation" novalidate>
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom02">Solution Project Name</label>
                                                <input type="text" class="form-control" name="solution_project_name" id="validationCustom02" placeholder="Project Name" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <label for="validationCustom02">Solution Description</label>
                                                <textarea class="form-control" id="validationCustom02" name="solution_description" placeholder="Solution Project Description" required></textarea>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <button class="btn btn-primary"  name="btnsave" type="submit"style="float: right">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </section>
