...
<head>
    ...
    <title>Institute - View Problem Statement</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="view_all_problems.php">Manage problem Statement</a></li>
                                ...
                                <form class="needs-validation" method="post" enctype="multipart/form-data"novalidate>
                                    <input type="hidden" value="<?php echo $problem_st_id ?>" name="hftxtprobid">
                                        ...
                                        <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="problem_category_id" id="validationCustom01"  value="<?php $row["problem_category_name"]; ?>" disabled/>
                                                <div class="valid-feedback">
                                                <select class="form-control custom-select" name="problem_category_id" disabled>
                                                    <?php 
