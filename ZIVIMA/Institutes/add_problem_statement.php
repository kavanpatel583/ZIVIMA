        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="view_all_problems.php">All Problems</a></li>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    if(isset($_REQUEST["btnsave"]))
                                    {
                                         ...
                                         problem_st_budget_end_amount,problem_st_added_datetime,problem_st_deadline_datetime,problem_st_tags,problem_st_advantages,
                                         types_of_area,problem_st_isactive,district_collector_id,district_id,problem_category_id) values ('".$_REQUEST["problem_st_title"]."',
                                         '".$_REQUEST["problem_st_description"]."','".$_REQUEST["problem_st_budget_start_amount"]."','".$_REQUEST["problem_st_budget_end_amount"]."',
                                         '".$_REQUEST["problem_st_added_datetime"]."','".$_REQUEST["problem_st_deadline_datetime"]."','".$_REQUEST["problem_st_tags"]."',
                                         '".$_REQUEST["problem_st_advantages"]."','".$_REQUEST["types_of_area"]."','".$_REQUEST["problem_st_isactive"]."',
                                         '".$_REQUEST["district_collector_id"]."','".$_REQUEST["district_id"]."','".$_REQUEST["problem_category_id"]."')");
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input name="problem_st_description" type="text" class="form-control"
                                                    id="validationCustom02" placeholder="Problem Description" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input name="problem_st_advantages" type="text" class="form-control"
                                                    id="validationCustom05" placeholder="problem_st_advantages" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Qualification.
                                                </div>
                                            </div>
