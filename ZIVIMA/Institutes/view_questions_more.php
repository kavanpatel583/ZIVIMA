        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="InstituteDashboard">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="view_pending_questions">Manage Questions</a></li>
                            ...
                            <div class="row">
                                ...
                                ?> -->
                                 ...
                                 if(isset($_REQUEST['btnsave']))
                                 {
                                      ...
                                      $result= mysqli_query($con,"update tbl_question set question_title ='".$_REQUEST["txtqtitle"]."',
                                      question_descriptio                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     n='".$_REQUEST["txtdesc"]."' where question_id='".$_REQUEST["txtqid"]."'");
