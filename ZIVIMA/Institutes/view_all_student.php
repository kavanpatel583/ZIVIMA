...
<head>
    ...
    <title>Institute - Students</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>List of Students</h4>
                </div>
                <!-- /Title -->
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 ">
                                            ...
                                            <tbody>
                                             ...
                                             $id = $_SESSION["insid"];
                                               $i=1;
                                               $res=mysqli_query($con,"select st.*,inst.institute_name from tbl_student st left join tbl_institute as inst on st.institute_id=inst.institute_id where inst.institute_id = '".$id."'");
