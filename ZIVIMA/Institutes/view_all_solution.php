...
<head>
    ...
    <title>ZIVIMA-View Solutions</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="InstituteDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage All Solutions</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                                    ...
                                    <div class="table-wrap">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <tbody>
                                             ...
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select sol.*,stat.problem_st_title from tbl_solution sol left join tbl_problem_statement as stat on sol.problem_st_id=stat.problem_st_id");
