        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="InstituteDashboard">Dashboard</a></li>
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Solutions</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                                    ...
                                    <input type="hidden" value="<?php echo $solution_id ?>" name="hftxtsolnid">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                value="<?php echo $solution_project_name; ?>" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <label for="validationCustom02">Description</label>
                                                <textarea class="form-control" id="validationCustom02" name="solution_description" placeholder="e.g. Description" 
                                                 required><?php echo $solution_description; ?></textarea>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        </div>
                                        <button class="btn btn-primary" name="btnsave" type="submit" style="float: right">Update</button>
                                    </form>
                                </div>
                            </div>
                        </section>
