        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="StateAdminDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="view_institute.php">Manage Institute</a></li>
                    <li class="breadcrumb-item active" aria-current="page">View Institute</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>View Institute</h4>
                </div>
                <!-- /Title -->
                                ...
                                ?>
                                    ...
                                    <input type="hidden" value="<?php echo $insid ?>" name="hftxtinsid">
                                            ...
                                            <div class="col-md-8 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="institute_name" id="validationCustom01" placeholder="e.g. C.k Pithawala" value="<?php echo $name; ?>" disabled>
                                            ...
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="institute_code" id="validationCustom02" placeholder="e.g. 009" value="<?php echo $code; ?>" disabled>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>  
                                        ...
                                        <label for="validationCustom01">District Collector</label>
                                                    <select class="form-control custom-select" name="state_admin_id" disabled>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <textarea name="institute_address" class="form-control" id="validationCustom03" name="" value="" placeholder="Institute Address" disabled><?php echo $address; ?></textarea>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="institute_pincode" id="validationCustom03" value="<?php echo $code; ?>" placeholder="Pincode" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" name="institute_landmark" value="<?php echo $landmark; ?>" placeholder="Landmark" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom04" placeholder="Latitude" value="<?php echo $lati; ?>" name="institute_latitude" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Longitude" value="<?php echo $long; ?>" name="institute_longitude" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" name="institute_email" class="form-control" id="validationCustomUsername" value="<?php echo $email; ?>" placeholder="Email" aria-describedby="inputGroupPrepend" disabled>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" name="institute_contact" id="validationCustomUsername" value="<?php echo $contact; ?>" placeholder="Contact  " aria-describedby="inputGroupPrepend" disabled>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom04" name="institute_uname" value="<?php echo $uname; ?>" placeholder="Username" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" name="institute_pwd" value="<?php echo $pwd; ?>" placeholder="Password" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" name="institute_main_person" value="<?php echo $main; ?>" placeholder="Institute Main Person" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="institute_website" class="form-control" id="validationCustomUsername" value="<?php echo $website; ?>" placeholder="Website" aria-describedby="inputGroupPrepend" disabled>
                                                    <div class="invalid-feedback">
                                             ...
                                             <textarea name="about_institute" class="form-control" id="validationCustom03" name="" value="" placeholder="Something about institute" disabled><?php echo $about; ?></textarea>
                                                </div>
                                                ...
                                                <input type="radio" class="custom-control-input" id="customControlValidation2" name="institute_isactive" value="1"  <?php if($isactive==1) { ?> checked="checked" <?php } ?> checked="checked" disabled>
                                            <label class="custom-control-label" for="customControlValidation2">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio mb-10">
                                        <input type="radio" class="custom-control-input" id="customControlValidation3" name="institute_isactive" value="0"  <?php if($isactive==0) { ?> checked="checked" <?php } ?> disabled>
