...
<head>
    ...
    <title>View Pending Questions</title>
       ...
       <?php include 'Header.php';?>
        ...
        <div class="hk-pg-wrapper">
            ...
            <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Manage Pending Questions</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Pending Questions</h4>
                </div>
                <!-- /Title -->
                <?php
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_question where question_id='".$_REQUEST['hfdelque']."'");
                if($res)
                {
                     echo "<script>window.location='view_pending_questions.php';</script>";
                } else {
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display">
                                            ...
                                            <tbody>
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from tbl_question");
                                            ...
                                            ?> 
                                                <tr>     
                                                    ...
                                                    <td><a  href="view_questions_more.php?edit=<?php echo $row["question_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelque" name="hfdelque" />
                                                </div>
