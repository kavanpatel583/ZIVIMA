                                    ...
                                    <div class="table-wrap">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <tbody>
                                             ...
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select sol.*,stat.problem_st_title from tbl_solution sol left join tbl_problem_statement as stat on sol.problem_st_id=stat.problem_st_id where sol.solution_isapproved_institute='no'");
                                            ...
                                            ?> 
                                                <tr>
                                                    ...
                                                    <td><a href="view_solution_more.php?edit=<?php echo $row["solution_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                            ...
                                                            <a href="" data-id="<?php echo $row["solution_id"] ?>" data-toggle="modal" data-target="#exampleModal1" class="btn btn-sm btn-outline-success btnapprove"  data-toggle="tooltip" data-placement="top" data-original-title="Approve"><i class="icon-like"></i></a> 
                                                    </td>
                                                </tr>
                                              <?php 
                                              $i++;
