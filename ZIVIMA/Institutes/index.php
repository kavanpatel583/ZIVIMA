...
<head>
    ...
    <title>ZIVIMA - Institute Login</title>
            ...
            <div class="container-fluid">
                <div class="row">
                   ...
                   <?php 
                    ...
                    {
                             $res=mysqli_query($con,"select * from tbl_institute where institute_uname='".$_REQUEST["txtusername"]."' and institute_pwd='".$_REQUEST["txtpassword"]."'");
                             if(mysqli_num_rows($res)>0)
                             {
                                ...
                                if($uname == $_REQUEST["txtusername"] && $pass == $_REQUEST["txtpassword"])
                                {
                                    $_SESSION["iname"]=$name;
                                    $_SESSION["insid"]=$id;
                                    echo "<script>window.location='InstituteDashboard.php';</script>";
                                } else {
                            ...
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                ...
                                <h1 class="display-4 mb-10">Welcome Back :)</h1>
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" name="txtusername" placeholder="Username" type="text">
                                    </div>
                                    <div class="form-group">
