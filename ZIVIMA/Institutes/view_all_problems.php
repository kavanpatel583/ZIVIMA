...
<head>
    ...
    <title>ZIVIMA-All Problems</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="InstituteDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage Problem Statements</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>All Problems</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <!-- <button onClick="window.location='add_problem_statement.php';" class="btn btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Problems</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               ...
                                               $res=mysqli_query($con,"select PS.*,DC.district_collector_name,D.district_name from tbl_problem_statement PS LEFT JOIN tbl_district_collector as DC ON DC.district_collector_id=PS.district_collector_id LEFT JOIN tbl_district as D on D.district_id=DC.district_id ORDER BY problem_st_id ASC");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php  $row["problem_st_isactive"]; 
                                                        if($row["problem_st_isactive"] == 1)
                                                        $row["problem_st_isactive"] = "YES";
                                                        else
                                                        $row["problem_st_isactive"] = "NO";
                                                        print($row["problem_st_isactive"]);
                                                    
                                                    
                                                    ?></td>
                                                    <td><a href="view_problem_more.php?edit=<?php echo $row["problem_st_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
