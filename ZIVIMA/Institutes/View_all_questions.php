...
<head>
    ...
    <title>Institute - Questions</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Questions</h4>
                </div>
                <!-- /Title -->
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                     ...
                                     <div class="dt-buttons btn-group">          
                                            ...
                                            <!--Add button-->
                                        <button onClick="window.location='add_questions.php';" class="btn btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        ...
                                        <!--End of Add button-->
                                         ...
                                         <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               ...
                                               $res=mysqli_query($con,"select Q.*,ST.student_name,I.institute_name from tbl_question Q LEFT JOIN tbl_student as ST ON ST.student_id=Q.student_id LEFT JOIN tbl_institute as I on I.institute_id=ST.institute_id ORDER BY question_id ASC");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["question_added_datetime"]; ?></td>
                                                    <td><?php echo $row["student_name"]; ?></td>
                                                    <td><?php echo $row["institute_name"]; ?></td>
                                                    
                                                    <td> <td><a  href="view_questions_more.php?edit=<?php echo $row["question_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                    <a  href="update_questions.php?edit=<?php echo $row["question_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                            data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a href="" data-id="<?php echo $row["question_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a>
                                                    <a  href="add_reply.php?edit=<?php echo $row["question_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a> </td>                                           
                                                </td>
                                                </tr>
                                              <?php 
                                              $i++;
