...
session_start();
if(!isset($_SESSION["iname"])  && !isset($_SESSION["insid"]))
{
       ...
       <?php include 'Header.php'; ?>
        ...
        <div class="hk-pg-wrapper">
            ...
            <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="InstituteDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage New Students</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>New Students</h4>
                </div>
                <!-- /Title -->
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_student where student_id='".$_REQUEST['hfdelstudent']."'");
                if($res)
                {
...
<?php
                if(isset($_REQUEST['btnapprovve']))
                    {
                        
                        $res = mysqli_query($con,"update  tbl_student set student_isapproved='yes' where student_id='".$_REQUEST['hfapstu']."'");
                        if($res)
                        {
                            echo "<script>window.location='view_all_student.php';</script>";
                        } else {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_students.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 ">
                                            ...
                                            <tbody>
                                             ...
                                             $id = $_SESSION["insid"];
                                               $i=1;
                                               $res=mysqli_query($con,"select st.*,inst.institute_name from tbl_student st left join tbl_institute as inst on st.institute_id=inst.institute_id where st.student_isapproved	='no' and inst.institute_id='".$id."'");
                                               while($row=mysqli_fetch_array($res))
                                              {
                                            ?> 
                                                <tr>     
                                                    <td><?php echo $i; ?></td>
                                                    <td><img src="../uploads/student/<?php echo $row["student_profile_picture"]; ?>" style="height:80px; width:80px;" /></td>
                                                    <td><?php echo $row["student_name"]; ?></td>
                                                    <td><?php echo $row["student_contact"]; ?></td>
                                                    <td><?php echo $row["student_email"]; ?></td>
                                                    <td><?php echo $row["institute_name"]; ?></td>
                                                    <td><?php echo $row["student_isapproved"]; ?></td>
                                                    <td><a href="view_students_more.php?edit=<?php echo $row["student_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                    <a  href="update_student.php?edit=<?php echo $row["student_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                            data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a href="" data-id="<?php echo $row["student_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> 
                                                    <a href="" data-id="<?php echo $row["student_id"] ?>" data-toggle="modal" data-target="#exampleModal1" class="btn btn-sm btn-outline-success btnapprove"  data-toggle="tooltip" data-placement="top" data-original-title="Approve"><i class="icon-like"></i></a> 
                                                    </td>
                                                </tr>
                                                <?php 
                                              $i++;
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelstudent" name="hfdelstudent" />
                                                </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfapstu" name="hfapstu" />
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                                    <button type="submit"  name="btnapprovve" class="btn btn-primary">Yes</button>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
    ...
    <script>
       $(document).ready(function(){
            ...
            $(".btndelete").click(function(){
                ...
                $("#hfdelstudent").val(studentid);
            });

            $(".btnapprove").click(function(){
                var studentid= $(this).data('id');
                $("#hfapstu").val(studentid);
            });
