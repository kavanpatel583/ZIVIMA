                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <!--Add button-->
                                        <!-- <button onClick="window.location='add_state.php';" class="btn btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display">
                                            ...
                                            ?> 
                                                <tr>     
                                                    ...
                                                    <td><?php echo $row["institute_contact"]; ?></td>


                                                    <td><a  href="view_institute_more.php?edit=<?php echo $row["institute_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a></td>                                           
                                                </tr>
                                                <?php 
                                              $i++;
                                            } ?>  
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelstu" name="hfdelstu" />
                                                </div>
