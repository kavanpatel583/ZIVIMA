        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="StateAdminDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="view_location_district.php">District</a></li>
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    if(isset($_REQUEST["edit"]))
                                    {
                                        ...
                                        {
                                            $id=$row["district_collector_id"];
                                            $name=$row["district_collector_name"];
                                            $contact=$row["district_collector_contact"];
                                            $username=$row["district_collector_uname"];                                        
                                            $isactv=$row["district_collector_isactive"];
                                 ...
                                 if(isset($_REQUEST['btnsave']))
                                 {
                                      ...
                                      $result= mysqli_query($con,"update tbl_district_collector set district_collector_name='".$_REQUEST["district_collector_name"]."',district_collector_uname='".$_REQUEST["district_collector_uname"]."',district_collector_contact='".$_REQUEST["district_collector_contact"]."',district_collector_isactive='".$_REQUEST["district_collector_isactive"]."',district_id='".$_REQUEST["district_id"]."' where district_collector_id='".$_REQUEST["txthfdcid"]."'");
                                    ...
                                    <input type="hidden" value="<?php echo $id;?>" name="txthfdcid"> 
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="district_collector_name" class="form-control" id="validationCustom01" placeholder="Collector name" value="<?php echo $name; ?>" required>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="district_collector_uname" class="form-control" id="validationCustom01" placeholder="Username" value="<?php echo $username; ?> " required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                               ...
                                               $res=mysqli_query($con,"select * from tbl_district where district_id not in (select district_id from tbl_district_collector where district_collector_id!='".$_REQUEST["edit"]."')");
                                               while($row=mysqli_fetch_array($res))
                                              {
                                            ?>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="number" name="district_collector_contact" class="form-control" id="validationCustom01" placeholder="Contact" value="<?php echo $contact; ?>" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <input type="radio" class="custom-control-input" id="customControlValidation2" name="district_collector_isactive" value="yes"  <?php if($isactv=='yes') { ?> checked="checked" <?php } ?>  required>
                                            <label class="custom-control-label" for="customControlValidation2">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio mb-10">
                                            <input type="radio" class="custom-control-input" id="customControlValidation3" name="district_collector_isactive" value="no"  <?php if($isactv=='no') { ?> checked="checked" <?php } ?> required>
