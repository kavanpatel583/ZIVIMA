...
<head>
    ...
    <title>Admin - Solution Pending</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="">Solutions</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Pending Solutions</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <!-- <button onClick="window.location='add_pending_solution.php';" class="btn btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Pending Solution</span> 
