        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
              ...
              if(isset($_REQUEST['btnapprovve']))
              {
                  ...
                  $res = mysqli_query($con,"update tbl_problem_statement set problem_st_isactive='yes' where problem_st_id='".$_REQUEST['hfapprobst']."'");
                  if($res)
                  {
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    if($row["problem_st_isactive"] == 'yes')
                                                        $row["problem_st_isactive"] = "Approved";
                                                        else
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="" data-id="<?php echo $row["problem_st_id"] ?>" data-toggle="modal" data-target="#exampleModal1" class="btn btn-sm btn-outline-success btnapprove"  data-toggle="tooltip" data-placement="top" data-original-title="Approve"><i class="icon-like"></i></a> 
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfapprobst" name="hfapprobst" />
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
