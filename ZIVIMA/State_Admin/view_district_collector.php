...
<head>
    ...
    <title>Admin - View District Collector</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="StateAdminDashboard.php"> Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">District collector</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>District Collector</h4>
                </div>
                <!-- /Title -->
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_district_collector where district_collector_id='".$_REQUEST['hfdeldc']."'");
                if($res)
                {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_district_collector.php';" class="btn btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Collector</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            //    $res=mysqli_query($con,"select DC.*,D.district_name from tbl_district_collector DC LEFT JOIN tbl_district as D ON D.district_id=DC.district_id ORDER BY district_collector_id DESC");
                                            $res=mysqli_query($con,"select DC.*,D.district_name,STA.state_name,STADL.state_admin_name from tbl_district_collector DC LEFT JOIN tbl_district as D ON D.district_id=DC.district_id LEFT JOIN tbl_state as STA ON STA.state_id=D.state_id  LEFT JOIN tbl_state_admin_login as STADL ON STADL.state_id=STA.state_id WHERE STADL.state_admin_name='".$current_sa."' ORDER BY district_collector_id DESC");

                                            // select DC.*,D.district_name,STA.state_name,STADL.state_admin_name from tbl_district_collector DC LEFT JOIN tbl_district as D ON D.district_id=DC.district_id LEFT JOIN tbl_state as STA ON STA.state_id=D.state_id  LEFT JOIN tbl_state_admin_login as STADL ON STADL.state_id=STA.state_id WHERE STADL.state_admin_name="vijay Rupani" ORDER BY district_collector_id DESC


                                               
                                                
                                            //    "select * from tbl_district_collector ORDER BY district_collector_id DESC"  OLD QUERY
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["district_collector_contact"]; ?></td>
                                                    <td><?php echo $row["district_collector_isactive"]; ?></td>
                                                    <td><a href="view_district_collector_more.php?edit=<?php echo $row["district_collector_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                    <a  href="update_district_collector.php?edit=<?php echo $row["district_collector_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                            data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    
                                                    <a href="" data-id="<?php echo $row["district_collector_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdeldc" name="hfdeldc" />
                                                </div>
