        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Update News</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                ...
                                <?php 
                                 ...
                                 if(isset($_REQUEST['btnsave']))
                                 {
                                      ...
                                      $result= mysqli_query($con,"update tbl_news set news_title='".$_REQUEST["news_title"]."',news_title_description='".$_REQUEST["news_title_description"]."',news_description='".$_REQUEST["news_description"]."' where news_id='".$_REQUEST["txthfnewsid"]."'");
                                
                                      if($result)
                                      {
                                        $id=$_REQUEST["txthfnewsid"];
                                ...
                                ?>
                                    ...
                                    <input type="hidden" value="<?php echo $id;?>" name="txthfnewsid"> 
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="news_title" class="form-control" id="validationCustom01" placeholder="Title of News" value="<?php echo $newstitle; ?>" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="news_title_description" class="form-control" id="validationCustom01" placeholder="Title Description of News"  value="<?php echo $titledesc; ?>" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 mb-10">
                                           ...
                                           <div class="form-row">
                                                <div class="col-md-12 mb-10">
                                                    ...
                                                    <input type="text" name="news_description" class="form-control" id="validationCustom01" placeholder="Detailed Description"  value="<?php echo $newsdesc; ?>" required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
