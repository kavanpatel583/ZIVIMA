        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Utility Events</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Utility Events</h4>
                </div>
                <!-- /Title -->
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_event where event_id='".$_REQUEST['hfdelevent']."'");
                if($res)
                {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_utility_events.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Utility Events</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 ">
                                            ...
                                            <tbody>
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from tbl_event") or die(mysqli_error($con));
                                            ...
                                            ?> 
                                                <tr>     
                                                    ...
                                                    <td><?php echo $row["event_isactive"]; ?></td>
                                                    <td><?php echo $row["event_isapproved"]; ?></td>
                                                    <td>
                                                        ...
                                                        <a  href="update_utility_events.php?edit=<?php echo $row["event_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                                data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        <a href="" data-id="<?php echo $row["event_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                                    </td>                                           
                                                </tr>
                                                <?php 
                                              $i++;
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelevent" name="hfdelevent" />
                                                </div>
