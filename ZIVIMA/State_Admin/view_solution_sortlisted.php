...
<head>
    ...
    <title>Admin - View shortlisted problem</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Sortlisted Solutions</table></h4>
                </div>
                <!-- /Title -->
