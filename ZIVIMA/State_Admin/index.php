...
<head>
    ...
    <title>ZIVIMA - State Admin Login</title>
            ...
            <div class="container-fluid">
                <div class="row">
                   ...
                   <?php #endregion
                    ...
                    {
                             $res=mysqli_query($con,"select * from tbl_state_admin_login where state_admin_uname='".$_REQUEST["txtusername"]."' and state_admin_pwd='".$_REQUEST["txtpassword"]."'");
                             if(mysqli_num_rows($res)>0)
                             {
                                ...
                                if($uname == $_REQUEST["txtusername"] && $pass == $_REQUEST["txtpassword"])
                                {
                                    ...
                                    $_SESSION["sid"]=$id;
                                    echo "<script>window.location='StateAdminDashboard.php';</script>";
                                } else {
