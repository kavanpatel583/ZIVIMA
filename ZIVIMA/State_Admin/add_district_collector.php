        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="StateAdminDashboard.php">Dashboard</a></li>
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add District Collector</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add District Collector</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_district_collector (state_admin_id,district_id,district_collector_name,district_collector_uname,district_collector_pwd,district_collector_contact) values ('".$_SESSION["sid"]."','".$_REQUEST["district_id"]."','".$_REQUEST["district_collector_name"]."','".$_REQUEST["district_collector_uname"]."','".$_REQUEST["district_collector_pwd"]."','".$_REQUEST["district_collector_contact"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                         } else {
                                ...
                                ?>
                                    ...
                                    <div class="col-md-12 mb-10">
                                               ...
                                               $res=mysqli_query($con,"select D.*,STA.state_name,STADL.state_admin_name from tbl_district D LEFT JOIN tbl_state as STA on STA.state_id=D.state_id LEFT JOIN tbl_state_admin_login as STADL on STADL.state_id=STA.state_id where district_id not in (select district_id from tbl_district_collector) and STADL.state_admin_name='".$current_sa."'");
                                            //    $res=mysqli_query($con,"select * from tbl_district where district_id not in (select district_id from tbl_district_collector)");
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="district_collector_name" class="form-control" id="validationCustom01" placeholder="Collector name" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="district_collector_uname" class="form-control" id="validationCustom01" placeholder="Username" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="district_collector_pwd" class="form-control" id="validationCustom01" placeholder="Password" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="number" name="district_collector_contact" class="form-control" id="validationCustom01" placeholder="Contact" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
