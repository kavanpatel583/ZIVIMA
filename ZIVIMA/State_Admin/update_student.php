        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Update Student</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                ...
                                ?>
                                    ...
                                    <input type="hidden" value="<?php echo $student_id; ?>" name="txthfsid" />
                                        ...
                                        <label for="validationCustom02">Institute Id</label>
                                        <select class="form-control custom-select" name="institute_id" required >
                                        ...
                                        <?php 
                                              ...
                                              {
                                            ?>                                                
                                                <option value="<?php echo $row[0]; ?>"><?php echo $row["institute_name"]; ?></option>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_name" type="text" class="form-control" id="validationCustom02" value="<?php echo $student_name; ?>" required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_contact" type="number_format" class="form-control" id="validationCustom02" value="<?php echo $student_contact; ?>" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="student_uname" type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="<?php echo $student_uname; ?>" required>
                                        ...
                                        <div class="col-md-6 mb-10">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="student_email" type="email" class="form-control" id="exampleInputEmail_1" value="<?php echo $student_email; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-10">
                                                <label for="validationCustom03">Profile Photo</label>
                                                <div class="custom-file">
                                            <input name="student_profile_picture" type="file" class="custom-file-input" id="validatedCustomFile" value="<?php echo $student_profile_picture; ?>" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input name="student_department" type="text" class="form-control" id="validationCustom04" value="<?php echo $student_department; ?>" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <input name="student_dob" class="form-control" type="date" name="birthday" value="<?php echo $student_dob; ?>" />
                                                <div class="invalid-feedback">
                                                    Please provide a valid Department.
                                                </div>
                                    </div>
                                            <div class="col-md-4 mb-10">
                                                ...
                                                <input name="student_qualification" type="text" class="form-control" id="validationCustom05" value="<?php echo $student_qualification; ?>" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <input name="student_pwd" type="text" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" value="<?php echo $student_pwd; ?>" >
                                                <div class="invalid-feedback">
                                        ...
                                        <?php 
                                              ...
                                              {
                                            ?>                                                
                                                <option value="<?php echo $i; ?>"><?php echo $row["district_name"]; ?></option>
                                        ...
                                        <div class="col-md-6 mb-10">
                                            ...
                                            <input name="student_added_datetime" class="form-control" type="date" name="add_date" value="<?php echo $student_added_datetime ; ?>" />
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_approved_datetime" type="date" class="form-control" id="approved_date" value="<?php echo $student_approved_datetime; ?>" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Date.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row"> 
                                            ...
                                            <input name="student_isactive" type="radio" class="custom-control-input" id="customControlValidation2" value="1" <?php if($student_isactive==1) { ?> checked="checked" <?php } ?> required>
                                            <label class="custom-control-label" for="customControlValidation2">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input name="student_isactive" type="radio" class="custom-control-input" id="customControlValidation3" value="0" <?php if($student_isactive==0) { ?> checked="checked" <?php } ?> required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div>
                                                <div class="custom-control custom-radio mb-10">
                                            <input name="student_isapproved" type="radio" class="custom-control-input" id="customControlValidation4" value="0" <?php if($student_isapproved==0) { ?> checked="checked" <?php } ?>  required>
                                            <label class="custom-control-label" for="customControlValidation4">Pending</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input name="student_isapproved" type="radio" class="custom-control-input" id="customControlValidation5" value="1" <?php if($student_isapproved==1) { ?> checked="checked" <?php } ?>  required>
                                        ...
                                        <textarea name="student_address" class="form-control mt-15" ><?php echo $student_address; ?></textarea>
                                            </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="student_landmark" type="text" class="form-control" id="validationCustom02" placeholder="Landmark" value="<?php echo $student_landmark; ?>" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <input name="student_pincode" type="number_format" class="form-control" id="validationCustom02" placeholder="Pin Code" value="<?php echo $student_pincode; ?>" required>
