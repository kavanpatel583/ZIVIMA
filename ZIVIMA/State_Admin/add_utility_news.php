        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add News</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_news(state_admin_id,news_title,news_title_description,news_description) values ('".$_SESSION["sid"]."','".$_REQUEST["news_title"]."','".$_REQUEST["news_title_description"]."','".$_REQUEST["news_description"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                    ...
                                    <!-- <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="news_title" class="form-control" id="validationCustom01" placeholder="Title of News" value="" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="news_title_description" class="form-control" id="validationCustom01" placeholder="Title of News" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                        <div class="col-md-12 mb-10">
                                                <label for="validationCustom03">News Image</label>
                                           ...
                                           <div class="form-row">
                                                <div class="col-md-12 mb-10">
                                                    ...
                                                    <input type="text" name="news_description" class="form-control" id="validationCustom01" placeholder="Detailed Description" value="" required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
