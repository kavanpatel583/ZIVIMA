...
<head>
    ...
    <title>Admin - View Utility News</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Utility News</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Utility News</h4>
                </div>
                <!-- /Title -->
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_news where news_id='".$_REQUEST['hfdelnews']."'");
                if($res)
                {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_utility_news.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Utility News</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 ">
                                            ...
                                            <tbody>
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from tbl_news");
                                               while($row=mysqli_fetch_array($res))
                                              {
                                            ?> 
                                                <tr>     
                                                    <td><?php echo $i; ?></td>
                                                    <td><img src="../uploads/news/<?php echo $row["news_image"]; ?>" style="height:80px; width:80px;" /></td>
                                                    <td><?php echo $row["news_title"]; ?></td>
                                                    <td><?php echo $row["news_title_description"]; ?></td>
                                                    <td><?php echo $row["news_isactive"]; ?></td>
                                                    <td><?php echo $row["news_isapproved"]; ?></td>
                                                    <td>
                                                        <a href="view_utility_news_more.php?edit=<?php echo $row["news_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                        <a  href="update_utility_news.php?edit=<?php echo $row["news_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                                data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        <a href="" data-id="<?php echo $row["news_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                                    </td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelnews" name="hfdelnews" />
                                                </div>
