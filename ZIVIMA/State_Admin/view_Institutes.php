...
<head>
    ...
    <title>Admin - View Institute</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Institutes</h4>
                </div>
                <!-- /Title -->
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from tbl_institute ORDER BY institute_id ASC");
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelinstitute" name="hfdelinstitute" />
                                                </div>
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_institute where institute_id='".$_REQUEST['hfdelinstitute']."'");
                if($res)
                {
