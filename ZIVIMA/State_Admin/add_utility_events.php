                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_event(state_admin_id,event_title,event_description,event_datetime,event_venue,event_advantages,event_landmark,event_pincode,event_main_feature) 
                                         values ('".$_SESSION["sid"]."','".$_REQUEST["event_title"]."','".$_REQUEST["event_description"]."','".$_REQUEST["event_datetime"]."','".$_REQUEST["event_venue"]."','".$_REQUEST["event_advantages"]."','".$_REQUEST["event_landmark"]."','".$_REQUEST["event_pincode"]."','".$_REQUEST["event_main_feature"]."')");
                                         if($res)
                                         {
                                         echo "inserted ..";
                                    ...
                                    <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" placeholder="Event Venue" name="event_venue" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Date! 
                                                </div>
                                            </div>                                      
