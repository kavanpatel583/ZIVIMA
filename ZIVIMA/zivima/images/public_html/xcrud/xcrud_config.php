...
{
    // default connection
    public static $dbname = 'smnindv9_sagy'; // Your database name
    public static $dbuser = 'smnindv9_sagy'; // Your database username
    public static $dbpass = 'Sagy@12345'; // // Your database password
    public static $dbhost = '111.118.212.86:3306'; // Your database host, 'localhost' is default.
