...
}else if($_REQUEST['action']=='aadhar_number')
{
	...
	getjson("select sum(user_feed_back.point)/COUNT(*) AS REVIEW ,village_id from user_feed_back group by user_feed_back.village_id order by sum(user_feed_back.point)/COUNT(*) desc ");
}
