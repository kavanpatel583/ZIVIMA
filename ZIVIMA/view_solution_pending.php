        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="InstituteDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage Pending Solutions</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Pending Solutions</h4>
                </div>
                <!-- /Title -->
                    ...
                    if(isset($_REQUEST['btndelete']))
                    {
                        ...
                        $res = mysqli_query($con,"delete from tbl_solution where solution_id='".$_REQUEST['hfdelsoln']."'");
                        if($res)
                        {
                            echo "<script>window.location='view_solution_pending.php';</script>";
                        } else {
                    ...
                    if(isset($_REQUEST['btnapprovve']))
                    {
                        ...
                        $res = mysqli_query($con,"update tbl_solution set solution_isapproved_institute='1' where solution_id='".$_REQUEST['hfapsoln']."'");
                        if($res)
                        {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <!-- <button onClick="window.location='add_solution.php';" class="btn btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Solution</span> 
                                                <span class="icon-label"></span>
                                        </button> -->
                                        <!--End of Add button-->
                                        <hr/>
                                        <table id="datable_3" class="table table-hover w-100">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Project Name</th>
                                            ...
                                            <tbody>
                                             ...
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select sol.*,stat.problem_st_title from tbl_solution sol left join tbl_problem_statement as stat on sol.problem_st_id=stat.problem_st_id where sol.solution_isapproved_institute='0'");
                                            ...
                                            ?> 
                                                <tr>
                                                    ...
                                                    <td><?php $row["solution_isapproved_institute"]; 
                                                        ...
                                                        if($row["solution_isapproved_institute"] == 1)
                                                        $row["solution_isapproved_institute"] = "Approved";
                                                        else
                                                        $row["solution_isapproved_institute"] = "Pennding";
                                                    ...
                                                    <a  href="update_solution.php?edit=<?php echo $row["solution_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                            data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                            <a href="" data-id="<?php echo $row["solution_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a>
                                                            <a href="" data-id="<?php echo $row["solution_id"] ?>" data-toggle="modal" data-target="#exampleModal1" class="btn btn-sm btn-outline-danger btnapprove"  data-toggle="tooltip" data-placement="top" data-original-title="Approve"><i class="glyphicon glyphicon-trash"></i></a> 
                                                    </td>
                                                </tr>
                                              <?php 
                                              $i++;
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelsoln" name="hfdelsoln" />
                                                </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfapsoln" name="hfapsoln" />
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
    ...
    <script>
       $(document).ready(function(){
            ...
            $(".btndelete").click(function(){
                var solnid= $(this).data('id');
                $("#hfdelsoln").val(solnid);
            });
