...
<head>
    ...
    <title>District Collector - Add Problem Material</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="DistrictCollectorDashboard.php">Dashboard</a></li>
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Problem Material</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add Problem Material</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_problem_material (problem_st_id) values ('".$_REQUEST["problem_st_id"]."')") or die(mysqli_error($con));
                                         if($res)
                                         {
                                            echo "inserted ..";
                                            ...
                                            if($_FILES["problem_material_url"]["name"] !=NULL)
                                            {
                                                ...
                                                $newname="PM_".date('Ymdhis').".".$ext;
                                                 ...
                                                 mysqli_query($con,"update tbl_problem_material set problem_material_url ='".$newname."' where problem_material_id='".$id."'");
                                            }
                                ...
                                ?>
                                    ...
                                    <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="col-md-12 mb-10">
                                              ...
                                              {
                                            ?>
                                                    <option value="<?php echo $row["problem_st_id"]; ?>">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <div class="custom-file">
                                                    <input name="problem_material_url" type="file"
