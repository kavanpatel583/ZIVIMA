...
<head>
    ...
    <title>District Collector - View Problem Category</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="DistrictCollectorDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage Problem Category</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Problem Category</h4>
                </div>
                <!-- /Title -->
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_problem_category where problem_category_id='".$_REQUEST['hfdelprobcat']."'");
                if($res)
                {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_problem_category.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Problem category</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from tbl_problem_category ORDER BY problem_category_id ASC");
                                               while($row=mysqli_fetch_array($res))
                                              {
                                            ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><img src="../uploads/problem_category_icon/<?php echo $row["problem_category_icon"]; ?>" style="height:80px; width:80px;" /></td>
                                                    <td><?php echo $row["problem_category_name"]; ?></td>
                                                    <td><?php $row["problem_category_isactive"]; 
                                                    if($row["problem_category_isactive"] == 'yes')
                                                    $row["problem_category_isactive"] = "yes";
                                                    else
                                                    $row["problem_category_isactive"] = "no";
                                                    print($row["problem_category_isactive"]);

                                                    ?></td>
                                                    <td>
                                                        <a href="view_problem_category_more.php?edit=<?php echo $row["problem_category_id"] ?>"class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                        <a  href="update_problem_category.php?edit=<?php echo $row["problem_category_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                                data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        <a href="" data-id="<?php echo $row["problem_category_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete" 
                                                         data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                                    </td>
                                                </tr>
                                              <?php 
                                              $i++;
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelprobcat" name="hfdelprobcat" />
                                                </div>
