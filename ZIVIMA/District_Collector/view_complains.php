...
<head>
    ...
    <title>District Collector - Complains</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>List of Complains</h4>
                </div>
                <!-- /Title -->
                                     ...
                                     <div class="dt-buttons btn-group">          
                                         ...
                                         <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               ...
                                               $res=mysqli_query($con,"select C.*,U.user_name,D.district_name from tbl_complain C LEFT JOIN tbl_user as U on U.user_id=C.user_id LEFT JOIN tbl_district as D ON D.district_id=C.district_id ORDER BY complain_id DESC");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["complain_address"]; ?></td>
                                                    <td><?php echo $row["complain_added_datetime"]; ?></td>
