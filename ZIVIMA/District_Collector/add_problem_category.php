        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="DistrictCollectorDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="view_problem_category.php">Problem Category</a></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add Problem Category</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_problem_category (problem_category_name) values ('".$_REQUEST["problem_category_name"]."')");
                                         if($res)
                                         {
                                            echo "inserted ..";
                                            ...
                                            if($_FILES["problem_category_icon"]["name"] !=NULL)
                                            {
                                                ...
                                                $newname="PC_".date('Ymdhis').".".$ext;
  
                                                 move_uploaded_file($source,"../uploads/problem_category_icon/".$newname);
  
                                                 mysqli_query($con,"update tbl_problem_category set problem_category_icon ='".$newname."' where problem_category_id='".$id."'");
                                            }
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="problem_category_name" class="form-control" id="validationCustom01"
                                                 placeholder="Problem Category Name" value="" required>
