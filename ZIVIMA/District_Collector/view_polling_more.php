...
<head>
    ...
    <title>District Collector - Polling More</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Polling Question</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Polling Question</h4>
                </div>
                <!-- /Title -->
                                    ...
                                    <div class="col-md-12 mb-10">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="polling_question" id="validationCustom02" value="<?php echo $polling_question; ?>" disabled>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="answer1" id="validationCustom02" value="<?php echo $answer1; ?>" disabled>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="answer2" id="validationCustom02" value="<?php echo $answer2; ?>" disabled>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="answer3" id="validationCustom02" value="<?php echo $answer3; ?>" disabled>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="answer4" id="validationCustom02" value="<?php echo $answer4; ?>" disabled>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="answer5" id="validationCustom02" value="<?php echo $answer5; ?>" disabled>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                       ...
                                       <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="date" class="form-control" id="validationCustom03" name="polling_start_date" disabled>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="date" class="form-control" id="validationCustom03" name="polling_end_date" disabled>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Date! 
                                                </div>
                                            </div>                                      
