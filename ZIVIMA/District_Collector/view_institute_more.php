...
<head>
    ...
    <title>District Collector - View More Institute</title>
                                    ...
                                    <input type="hidden" value="<?php echo $insid; ?>" name="hftxtinsid" />
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <textarea type="text" name="institute_address" class="form-control" id="validationCustom03" name="" placeholder="Institute Address" disabled><?php echo $address ?></textarea>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" name="institute_pincode" value="<?php echo $code; ?>" id="validationCustom03" placeholder="Pincode" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" name="institute_landmark" placeholder="Landmark" value="<?php echo $landmark; ?>" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom04" placeholder="Latitude" name="institute_latitude" value="<?php echo $lati; ?>" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Longitude" name="institute_longitude" value="<?php echo $long; ?>"disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" name="institute_email" class="form-control" id="validationCustomUsername" placeholder="Email" aria-describedby="inputGroupPrepend" value="<?php echo $email;?>" disabled>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Contact number" name="institute_contact" value="<?php echo $contact; ?>"disabled>
                                                <div class="invalid-feedback">
                                                    Please enter valid Longitude
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom04" name="institute_uname" placeholder="Username" value="<?php echo $uname; ?>" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" name="institute_pwd" placeholder="Password" value="<?php echo $pwd; ?>" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" name="institute_main_person" placeholder="Institute Main Person" value="<?php echo $main; ?>" disabled>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <input type="file" name="institute_logo" class="custom-file-input" id="validatedCustomFile" value="<?php echo $logo;?>" disabled>
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <input type="file" class="custom-file-input" name="institute_coverpage" id="validatedCustomFile" value="<?php echo $cover;?>" disabled>
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <input type="file" class="custom-file-input" name="institute_image1" id="validatedCustomFile" value="<?php echo $img1;?>" disabled>
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <input type="file" class="custom-file-input" id="validatedCustomFile" name="institute_image2" value="<?php echo $img2;?>" disabled>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="institute_website" value="<?php echo $website; ?>" class="form-control" id="validationCustomUsername" placeholder="Website" aria-describedby="inputGroupPrepend" disabled>
                                                    <div class="invalid-feedback">
                                             ...
                                             <textarea type="text" name="about_institute" class="form-control"  id="validationCustom03" placeholder="Something about Institute" disabled><?php echo $about?></textarea>
                                                </div>
