...
<head>
    ...
    <title>District Collector - Update Problem</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update problem</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                    data-feather="external-link"></i></span></span>Update Problem</h4>
                </div>
                <!-- /Title -->
                                ...
                                <form class="needs-validation" method="post" enctype="multipart/form-data"novalidate>
                                    <input type="hidden" value="<?php echo $problem_st_id ?>" name="hftxtprobid">
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <textarea name="problem_st_description" class="form-control"
                                                    id="validationCustom02" placeholder="Problem Description"  required><?php echo $problem_st_description; ?></textarea>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <textarea name="problem_st_advantages"  class="form-control"
                                                    id="validationCustom05" placeholder="Enter advantages" required><?php echo $problem_st_advantages; ?></textarea>
                                        ...
                                        <div class="col-md-6 mb-10">
                                                ...
                                                <select class="form-control custom-select" name="types_of_area" value="<?php echo $types_of_area; ?>" >
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="problem_st_tags" type="text" class="form-control"
                                                    value="<?php echo $problem_st_tags; ?>" id="validationCustom05" placeholder="Enter tags" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Qualification.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="custom-file">
                                                    <input name="problem_st_canvas_image" type="file"
                                                        class="custom-file-input" id="validatedCustomFile" value="<?php echo $problem_st_canvas_image; ?>" >
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="problem_st_deadline_datetime" class="form-control" type="datetime"  value="<?php echo $problem_st_deadline_datetime; ?>" />
                                                <div class="invalid-feedback">
