...
<head>
    ...
    <title>District Collector - Students</title>
                                    ...
                                    <!--Copy pdf print buttons -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 ">
                                            ...
                                            <tbody>
                                             <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select st.*,inst.institute_name from tbl_student st left join tbl_institute as inst on st.institute_id=inst.institute_id");
