...
<head>
    ...
    <title>District Collector - Add Requested Problem</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="view_requested_problem.php">Manage Requested Problems</a></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                    data-feather="external-link"></i></span></span>Add Problem</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <?php 
                                    $dc_name=$_SESSION["dcname"];
                                    $dc_id=mysqli_query($con,"select district_collector_id from tbl_district_collector where district_collector_name='".$dc_name."'");
                                    
                                    while($row1 = mysqli_fetch_assoc($dc_id)){ 
                                    
                                            
                                            $district_collector_id=$row1['district_collector_id'];
                                        }
                                   
                                
                                    if(isset($_REQUEST["btnsave"]))
                                    {
                                         $res=mysqli_query($con,"insert into tbl_problem_statement(problem_st_title,problem_st_description,problem_st_budget_start_amount,
                                         problem_st_budget_end_amount,problem_st_deadline_datetime,problem_st_tags,problem_st_advantages,
                                         types_of_area,district_collector_id,problem_category_id) values ('".$_REQUEST["problem_st_title"]."',
                                         '".$_REQUEST["problem_st_description"]."','".$_REQUEST["problem_st_budget_start_amount"]."','".$_REQUEST["problem_st_budget_end_amount"]."','".$_REQUEST["problem_st_deadline_datetime"]."','".$_REQUEST["problem_st_tags"]."',
                                         '".$_REQUEST["problem_st_advantages"]."','".$_REQUEST["types_of_area"]."',
                                         '".$district_collector_id."','".$_REQUEST["problem_category_id"]."')");
                                         ...
                                         $id=mysqli_insert_id($con);
                                          ...
                                          if($_FILES["problem_st_canvas_image"]["name"] !=NULL)
                                          {
                                              ...
                                              $newname="ST_".date('Ymdhis').".".$ext;
                                               ...
                                               move_uploaded_file($source,"../uploads/images/".$newname);

                                               mysqli_query($con,"update tbl_problem_statement set problem_st_canvas_image ='".$newname."' where problem_st_id='".$id."'");
                                          }
                                          echo "<script>window.location='view_requested_problem.php';</script>";
                                         } else {
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="problem_st_title" type="text" class="form-control"
                                                    id="validationCustom02" placeholder="Problem Title" value="" required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <textarea name="problem_st_description" class="form-control"
                                                    id="validationCustom02" placeholder="Problem Description" value="" required></textarea>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <textarea name="problem_st_advantages"  class="form-control"
                                                    id="validationCustom05" placeholder="Enter advantages" required></textarea>
                                        ...
                                        <div class="col-md-6 mb-10">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="problem_st_tags" type="text" class="form-control"
                                                    id="validationCustom05" placeholder="Enter tags" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Qualification.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="problem_st_budget_start_amount" type="number" class="form-control"
                                                    id="validationCustom02" placeholder="Problem budget start amount" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input name="problem_st_budget_end_amount" type="number" class="form-control"
                                                    id="validationCustom02" placeholder="Problem budget end amount" value="" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>                                           
