...
<head>
    ...
    <title>District Collector - View Polling Questions</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Manage Polling Questions</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_polling_more.php?edit=<?php echo $row["polling_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
