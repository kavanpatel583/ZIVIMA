            ...
            <div class="container-fluid">
                <div class="row">
                   ...
                   <?php
                    ...
                    {
                             $res=mysqli_query($con,"select * from tbl_district_collector where district_collector_uname='".$_REQUEST["txtusername"]."' and district_collector_pwd='".$_REQUEST["txtpassword"]."'");
                             if(mysqli_num_rows($res)>0)
                             {
                                  while($row=mysqli_fetch_array($res))
                                  {
                                        ...
                                        $uname=$row["district_collector_uname"];
                                        $pass=$row["district_collector_pwd"];

                                  } 
                                
                                if($uname == $_REQUEST["txtusername"] && $pass == $_REQUEST["txtpassword"])
                                {
                                    $_SESSION["dcname"]=$name;
                                    $_SESSION["dcid"]=$dcid;
                                    $_SESSION["disid"]=$did;

                                    

                                    echo "<script>window.location='DistrictCollectorDashboard.php';</script>";
                                } else {
