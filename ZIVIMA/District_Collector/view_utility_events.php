...
<head>
    ...
    <title>Admin - View Institutes</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="view_utility_events.php">Utility Events</a></li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <?php
                    if(isset($_REQUEST['btndelete']))
                    {
                        ...
                        $res = mysqli_query($con,"delete from  tbl_news where news_id='".$_REQUEST['hfdelins']."'");
                        if($res)
                        {
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Utility Event</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from  tbl_event ORDER BY event_id ASC");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["event_added_datetime"]; ?></td>
