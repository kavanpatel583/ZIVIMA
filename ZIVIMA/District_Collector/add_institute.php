...
<head>
    ...
    <title>Disrict Collector - Add Institute</title>
                        ...
                        <section class="hk-sec-wrapper">
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    {
                                         $res=mysqli_query($con,"insert into tbl_institute (institute_name,institute_code,institute_address,institute_landmark,institute_pincode,
                                         institute_contact,institute_email,institute_website,about_institute,institute_uname,institute_pwd,institute_main_person,
                                         district_collector_id,district_id) values('".$_REQUEST["institute_name"]."','".$_REQUEST["institute_code"]."','".$_REQUEST["institute_address"]."',
                                         '".$_REQUEST["institute_landmark"]."','".$_REQUEST["institute_pincode"]."','".$_REQUEST["institute_contact"]."',
                                         '".$_REQUEST["institute_email"]."','".$_REQUEST["institute_website"]."','".$_REQUEST["about_institute"]."',
                                         '".$_REQUEST["institute_uname"]."', '".$_REQUEST["institute_pwd"]."','".$_REQUEST["institute_main_person"]."','".$dcid."','".$did."')");
                                         ...
                                         if($_FILES["institute_logo"]["name"] !=NULL)
                                         {
                                             ...
                                             $newname1="INS_".date('Ymdhis').".".$ext1;
                                    ...
                                    <form class="needs-validation" novalidate method="post" enctype="multipart/form-data" novalidate> 
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Contact number" name="institute_contact" required>
                                                <div class="invalid-feedback">
