        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Manage Institutes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Institutes</h4>
                </div>
                <!-- /Title -->
                ...
                <?php
                    if(isset($_REQUEST['btndelete']))
                    {
                        ...
                        $res = mysqli_query($con,"delete from tbl_institute where institute_id='".$_REQUEST['hfdelins']."'");
                        if($res)
                        {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_institute.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Institute</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                                ...
                                                $i=1;
                                                $res=mysqli_query($con,"select INS.*,D.district_name,DC.district_collector_name from tbl_institute INS LEFT JOIN tbl_district_collector as DC on DC.district_id=INS.district_id LEFT JOIN tbl_district as D ON D.district_id=DC.district_id where DC.district_collector_name='".$current_dc."'");
                                               while($row=mysqli_fetch_array($res))
                                              {
                                            ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><img src="../uploads/clg/<?php echo $row["institute_logo"]; ?>" style="height:80px; width:80px;" /></td>
                                                    <td><?php echo $row["institute_name"]; ?></td>
                                                    <td><?php echo $row["institute_code"]; ?></td>
                                                    <td><?php echo $row["institute_address"]; ?></td>
                                                    <td><a  href="view_institute_more.php?edit=<?php echo $row["institute_id"] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" data-original-title="View More"><i class="icon" data-icon="y"></i></a>
                                                    <a  href="update_institute.php?edit=<?php echo $row["institute_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                            data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        <a href="" data-id="<?php echo $row["institute_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                                </tr>
                                              <?php 
                                              $i++;
                                            } ?>   
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelins" name="hfdelins" />
                                                </div>
