...
<head>
    ...
    <title>District Collector - Update Problem Category</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="DistrictCollectorDashboard.php">Dashboard</a></li>
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Problem Category</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Update Problem Category</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="problem_category_name" class="form-control" id="validationCustom01"
                                                 placeholder="Problem Category Name" value="<?php echo $problem_category_name; ?>" required>
                                        ...
                                        <!-- <div class="form-row">
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <div class="custom-control custom-radio mb-10">
                                                    <input name="problem_category_isactive" type="radio" class="custom-control-input" id="customControlValidation2" value="yes" <?php if($problem_category_isactive=="yes") { ?> checked="checked" <?php } ?> required>
                                                    <label class="custom-control-label" for="customControlValidation2">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input name="problem_category_isactive" type="radio" class="custom-control-input" id="customControlValidation3" value="no" <?php if($problem_category_isactive=="no") { ?> checked="checked" <?php } ?> required>
