...
<head>
    ...
    <title>District Collector - View Problem Material</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="DistrictCollectorDashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage problem material</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Problem Material</h4>
                </div>
                <!-- /Title -->
              ...
              if(isset($_REQUEST['btndelete']))
              {
                ...
                $res = mysqli_query($con,"delete from tbl_problem_material where problem_material_id='".$_REQUEST['hfdelprobmat']."'");
                if($res)
                {
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <!--Add button-->
                                        <button onClick="window.location='add_problem_material.php';" class="btn btn-sm btn-success btn-wth-icon btn-lg" style="float:right;" >
                                        <span class=""><i class="ion ion-md-add-circle-outline"></i></span> </span>
                                            <span class="btn-text">Add Problem Material</span> 
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select PM.*,PS.problem_st_title from tbl_problem_material PM LEFT JOIN tbl_problem_statement as PS on PM.problem_st_id=PS.problem_st_id ORDER BY problem_material_id ASC");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><img src="../uploads/problem_material_url/<?php echo $row["problem_material_url"]; ?>" style="height:80px; width:80px;" /></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a  href="update_problem_material.php?edit=<?php echo $row["problem_material_id"] ?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip"
                                                                data-placement="top" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        <a href="" data-id="<?php echo $row["problem_material_id"] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-outline-danger btndelete"  data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="glyphicon glyphicon-trash"></i></a> </td>
                                                    </td>
                                                </tr>
                                              <?php 
                                              $i++;
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" id="hfdelprobmat" name="hfdelprobmat" />
                                                </div>
    ...
    <script>
       $(document).ready(function(){
            ...
            $(".btndelete").click(function(){
                var probmatid= $(this).data('id');
                $("#hfdelprobmat").val(probmatid);
            });
       });
    </script>             
