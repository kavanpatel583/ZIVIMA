...
<head>
    ...
    <title>District Collector - View Solutions</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Solutions</h4>
                </div>
                <!-- /Title -->
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               $i=1;
                                               $res=mysqli_query($con,"select * from tbl_solution ORDER BY solution_id ASC");
