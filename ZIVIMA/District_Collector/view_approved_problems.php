...
<head>
    ...
    <title>District Collector - All Problems</title>
       ...
       <?php include 'Header.php';?>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                ...
                <!-- <li class="breadcrumb-item"><a href="">Approved Problem Statements</a></li> -->
                    <li class="breadcrumb-item active" aria-current="page">Approved Problem</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                                    ...
                                    <div class="table-wrap">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100">
                                            ...
                                            <?php 
                                               ...
                                               $res=mysqli_query($con,"select PS.*,DC.district_collector_name,D.district_name from tbl_problem_statement PS LEFT JOIN tbl_district_collector as DC ON DC.district_collector_id=PS.district_collector_id LEFT JOIN tbl_district as D on D.district_id=DC.district_id where problem_st_isactive='yes' ORDER BY problem_st_id ASC");
